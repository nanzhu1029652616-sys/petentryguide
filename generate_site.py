...
ROUTES_DATA = [
    {
        ...
        "min_age": "6 months", "microchip": "ISO 11784/85 required",
        "rabies_vaccine": "Required", "quarantine": "No",
        "process_steps": [
            "Microchip the pet", "Administer rabies vaccination",
            "Obtain export health certificate", "Complete CDC import form", "Travel with approved airline"
        ],
        "required_documents": ["Export Health Certificate", "Rabies Vaccination Certificate", "CDC Import Form"],
    ...
    },
    {
        ...
        "summary": "Strict CDC requirements apply for importing a dog from China (high-risk country) to the USA.",
        "min_age": "6 months", "microchip": "ISO 11784/85 required",
        "rabies_vaccine": "Required (plus Titer Test)", "quarantine": "No (if requirements met)",
        "process_steps": [
            "Microchip the dog", "Administer rabies vaccination", "Pass Rabies Titer Test",
            "Obtain CDC Dog Import Permit", "Obtain export health certificate", "Travel with approved airline"
        ],
        "required_documents": ["Export Health Certificate", "Rabies Vaccination Certificate", "CDC Dog Import Permit", "Titer Test Results"],
        "vaccines": ["Rabies Vaccine"],
        "travel_methods": ["Cargo transport (primarily)"],
        "tips": ["China is on the CDC high-risk list. A valid Rabies Titer Test and CDC Permit are mandatory for dogs."]
    }
]
